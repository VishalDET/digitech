...
const Mobile = () => {
    return (
        <>
            <div className="mobile-app-main pt-0 mt-md-4">
                <img src="/assets/images/Mobile Application Development Banner.webp" alt="Best Mobile Application Development Company In India" className="img-fluid" loading="lazy" />
            </div>

            <section id="mobile-development-types" className="py-2 py-md-4 text-black" style={{ backgroundColor: '#ffffff !important' }}>
                <div className="container">
                    <h2 className="text-start display-5 fw-bold mb-3 text-purple">Our App Development Services</h2>
                    <p className="text-dark">We have mastered the art of developing <strong>custom mobile applications</strong> for various industries, including e-commerce, healthcare, education, finance, and travel over the years.</p>
            ...
            <section id="mobile-solution" className="py-5 text-dark bg-light">
                <div className="container">
                    <h2 className="text-start display-5 fw-bold mb-4 text-black">Why we are best</h2>

                    <p className="text-dark text-start mb-5">
                        We craft custom mobile applications with secure data management, push notifications, and responsive design. We develop on the latest technologies including <strong>Flutter</strong>, <strong>Java</strong>, <strong>Swift</strong>, and <strong>React Native</strong>.
                    </p>
                    ...
                    <div className="row justify-content-center flex-wrap">
                        ...
                        <div className="col-md-4" data-aos="fade-left">
                            <div className="d-flex justify-content-center align-items-center">
                                <img src="https://www.digitaledgetech.in/images/Mobile%20App%20Development.jpg" alt="Employee App 1" className="img-fluid rounded w-100" />
                            </div>
                        </div>
                    </div>
            ...
            <section id="request-app-development" className=" py-5 text-black">
                <div className="container">
                    <h2 className="text-start fw-bold mb-3 text-black">Request for App Development </h2>

                    <p className="lead text-start mb-5 text-dark">
                        <Link to="/contact" className="text-black fw-bold">Share your App Development requirements <i className="fa-solid fa-up-right-from-square fs-5"></i></Link> with us, and our team will help you develop the perfect Modern application tailored to your needs.
                    </p>
                </div>
            </section>
        </>
